...
import { RepertoireSheetRouteProps } from "./types";
import {
  Container,
  Content,
  Title,
...
export function RepertoireSheet() {
  ...
  const params: RepertoireSheetRouteProps =
    route.params as RepertoireSheetRouteProps;
  ...
  async function loadScreen() {
    ...
    try {
      ...
      Toast.show(
        "Houve um erro ao buscar a partitura. Por favor, verifique sua conexão, ou tente novamente mais tarde.",
